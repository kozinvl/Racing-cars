...
class GameState < State
  ...
  def load_player
    ...
    @player = Player.new(current_car[0],
  ...
  def next_car
    ...
    Car.new(car[0], @options[:cars_angle][angle_index],
  ...
  def update_cars
    return unless @distance - @distance_per_car > @distance_last_car ||
